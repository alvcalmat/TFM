...
\begin{lstlisting}[caption={General operation of \emph{High-Level Planner}'s code}, breaklines=true, label=ps:GeneralPlanner]
	...
	3. Configure \gls{ROS} communications (Publishers, Subscribers and ActionServers).
	4. Set the loop rate.
	...
	6. Wait until all \glspl{UAV} have finished and disconnected. While there is any agent connected do:
...
% Cuando uno de estos callbacks considera necesario realizar una nueva planificación de tareas, el código que 
...
\begin{lstlisting}[caption={}, breaklines=true, label=ps:]
	1. 
\end{lstlisting}
